// To parse this data:
//
//   import { Convert, GardenSchema } from "./file";
//
//   const gardenSchema = Convert.toGardenSchema(json);
//
...
export class Convert {
    public static toGardenSchema(json: string): GardenSchema {
        return cast(JSON.parse(json), r("GardenSchema"));
    }

    public static gardenSchemaToJson(value: GardenSchema): string {
...
const typeMap: any = {
    ...
    "Theme": o([
        ...
        { json: "primary_color", js: "primary_color", typ: u(undefined, u(null, "")) },
        { json: "secondary_color", js: "secondary_color", typ: u(undefined, u(null, "")) },
        { json: "text_color", js: "text_color", typ: u(undefined, u(null, "")) },
    ], "any"),
};
