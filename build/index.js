        ...
        /* @__PURE__ */ jsxs(
          index,
          {
            ...
            children: [
              ...
              (currentGarden?.data?.label ?? schema.name) && /* @__PURE__ */ jsx(Panel, { position: "top-right", children: /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  style: {
                    color: (currentGarden?.data?.theme ?? schema.theme)?.primary_color ?? void 0,
                    borderColor: (currentGarden?.data?.theme ?? schema.theme)?.secondary_color ?? void 0
                  },
                  children: [
                    /* @__PURE__ */ jsx(Flower, { className: "garden:h-4 garden:w-4" }),
                    currentGarden?.data?.label ?? schema.name ?? "Garden",
                    (currentGarden?.data?.icon ?? schema.icon) && /* @__PURE__ */ jsx("span", { className: "garden:ml-1", children: currentGarden?.data?.icon ?? schema.icon })
                  ]
                }
              ) }),
