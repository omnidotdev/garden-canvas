...
function DefaultNode$1({ data, isConnectable, targetPosition = Position.Top, sourcePosition = Position.Bottom, }) {
...
class Convert {
  static toGardenSchema(json) {
    return cast(JSON.parse(json), r("GardenSchema"));
  }
  static gardenSchemaToJson(value) {
    return JSON.stringify(uncast(value, r("GardenSchema")), null, 2);
  }
}
...
const typeMap = {
  "GardenSchema": o([
    { json: "created_at", js: "created_at", typ: u(void 0, u(null, "")) },
    { json: "description", js: "description", typ: u(void 0, u(null, "")) },
    { json: "edges", js: "edges", typ: u(void 0, u(a(r("Edge")), null)) },
    { json: "maintainers", js: "maintainers", typ: u(void 0, u(a(r("Maintainer")), null)) },
    { json: "name", js: "name", typ: "" },
    { json: "sprouts", js: "sprouts", typ: u(void 0, u(a(r("Sprout")), null)) },
    { json: "subgardens", js: "subgardens", typ: u(void 0, u(a(r("Garden")), null)) },
    { json: "supergardens", js: "supergardens", typ: u(void 0, u(a(r("Garden")), null)) },
    { json: "theme", js: "theme", typ: u(void 0, u(null, r("Theme"))) },
    { json: "updated_at", js: "updated_at", typ: u(void 0, u(null, "")) },
    { json: "version", js: "version", typ: u(void 0, u(null, "")) }
  ], "any"),
  "Edge": o([
    { json: "description", js: "description", typ: u(void 0, u(null, "")) },
    { json: "label", js: "label", typ: u(void 0, u(null, "")) },
    { json: "relations", js: "relations", typ: u(void 0, u(a(""), null)) },
    { json: "source", js: "source", typ: "" },
    { json: "status", js: "status", typ: u(void 0, u(null, "")) },
    { json: "target", js: "target", typ: "" }
  ], "any"),
  "Maintainer": o([
    { json: "email", js: "email", typ: u(void 0, u(null, "")) },
    { json: "name", js: "name", typ: "" },
    { json: "url", js: "url", typ: u(void 0, u(null, "")) }
  ], "any"),
  "Sprout": o([
    { json: "description", js: "description", typ: u(void 0, u(null, "")) },
    { json: "homepage_url", js: "homepage_url", typ: "" },
    { json: "logo", js: "logo", typ: u(void 0, u(null, "")) },
    { json: "name", js: "name", typ: "" },
    { json: "project_url", js: "project_url", typ: u(void 0, u(null, "")) },
    { json: "repo_url", js: "repo_url", typ: u(void 0, u(null, "")) },
    { json: "twitter", js: "twitter", typ: u(void 0, u(null, "")) }
  ], "any"),
  "Garden": o([
    { json: "created_at", js: "created_at", typ: u(void 0, u(null, "")) },
    { json: "description", js: "description", typ: u(void 0, u(null, "")) },
  ...
  "Theme": o([
    { json: "background_color", js: "background_color", typ: u(void 0, u(null, "")) },
    { json: "primary_color", js: "primary_color", typ: u(void 0, u(null, "")) },
    { json: "secondary_color", js: "secondary_color", typ: u(void 0, u(null, "")) },
    { json: "text_color", js: "text_color", typ: u(void 0, u(null, "")) }
  ], "any")
};
...
const Flower = createLucideIcon("flower", __iconNode$6);
...
const Layers2 = createLucideIcon("layers-2", __iconNode$3);
...
const DefaultNode = ({ data }) => {
  ...
  const hasBottomTargets = data.targetConnections?.some(
    (id) => id.includes("bottom")
  );
  const hasLeftTargets = data.targetConnections?.some(
    (id) => id.includes("left")
  );
  const hasTopSources = data.sourceConnections?.some(
    (id) => id.includes("top")
  );
  ...
  return (
    ...
    /* @__PURE__ */ jsxs("div", { className: "garden:relative garden:rounded-md garden:border garden:border-muted garden:bg-card garden:p-2", children: [
      hasTopSources && /* @__PURE__ */ jsx(Handle, { type: "source", position: Position.Top }),
      hasBottomSources && /* @__PURE__ */ jsx(Handle, { type: "source", position: Position.Bottom }),
      hasTopTargets && /* @__PURE__ */ jsx(Handle, { type: "target", position: Position.Top }),
      hasBottomTargets && /* @__PURE__ */ jsx(Handle, { type: "target", position: Position.Bottom }),
      hasLeftTargets && /* @__PURE__ */ jsx(Handle, { type: "target", position: Position.Left }),
      /* @__PURE__ */ jsx("div", { className: "garden:p-2", children: data.label })
    ] })
  );
};

const GardenNode = ({ data }) => {
    ...
    /* @__PURE__ */ jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "garden:flex garden:flex-col garden:items-center garden:justify-center garden:gap-2 garden:rounded-md garden:p-4 garden:text-center garden:text-foreground", children: [
            /* @__PURE__ */ jsx(
              Sprout,
              {
                size: 24,
            ...
            /* @__PURE__ */ jsx("h3", { className: "garden:font-bold", children: data.label }),
            data.description && /* @__PURE__ */ jsx("h4", { className: "garden:text-foreground/70 garden:text-sm", children: data.description })
          ] })
        ]
      }
    )
...
const SubgardenNode = ({ data }) => {
  const hasSources = data.sourceConnections && data.sourceConnections.length > 0;
  const primaryColor = data.theme?.primary_color || "var(--garden-garden)";
  const secondaryColor = data.theme?.secondary_color || "var(--garden-garden)/40";
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "garden:flex garden:cursor-pointer garden:flex-col garden:items-center garden:gap-4 garden:rounded-lg garden:p-4 garden:text-center", children: [
          /* @__PURE__ */ jsx("div", { className: "garden:flex garden:w-full garden:justify-center", children: /* @__PURE__ */ jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxs("div", { className: "garden:flex garden:flex-col garden:items-center garden:gap-2 garden:p-2", children: [
            /* @__PURE__ */ jsx(
              GitBranch,
              {
                size: 24,
            ...
            /* @__PURE__ */ jsx("h3", { className: "garden:font-bold garden:text-foreground", children: data.label }),
            data.description && /* @__PURE__ */ jsx("h4", { className: "garden:line-clamp-2 garden:text-foreground/70 garden:text-sm", children: data.description })
          ] })
        ] })
      ]
    }
...
const buttonVariants = cva(
  "garden:cursor-pointer garden:disabled:cursor-not-allowed garden:inline-flex garden:items-center garden:justify-center garden:gap-2 garden:whitespace-nowrap garden:rounded-md garden:text-sm garden:font-medium garden:transition-all garden:disabled:pointer-events-none garden:disabled:opacity-50 garden:[&_svg]:pointer-events-none garden:[&_svg:not([class*=size-])]:size-4 garden:shrink-0 garden:[&_svg]:shrink-0 garden:outline-none garden:focus-visible:border-ring garden:focus-visible:ring-ring/50 garden:focus-visible:ring-[3px] garden:aria-invalid:ring-destructive/20 garden:dark:aria-invalid:ring-destructive/40 garden:aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "garden:bg-primary garden:text-primary-foreground garden:shadow-xs garden:hover:bg-primary/90",
        destructive: "garden:bg-destructive garden:text-white garden:shadow-xs garden:hover:bg-destructive/90 garden:focus-visible:ring-destructive/20 garden:dark:focus-visible:ring-destructive/40 garden:dark:bg-destructive/60",
        outline: "garden:border garden:bg-background garden:shadow-xs garden:hover:bg-accent garden:hover:text-accent-foreground garden:dark:bg-input/30 garden:dark:border-input garden:dark:hover:bg-input/50",
        secondary: "garden:bg-secondary garden:text-secondary-foreground garden:shadow-xs garden:hover:bg-secondary/80",
        ghost: "garden:hover:bg-accent garden:hover:text-accent-foreground garden:dark:hover:bg-accent/50",
        ...
        children: [
          ...
          showCloseButton && /* @__PURE__ */ jsxs(
            Close,
            {
              ...
              children: [
                /* @__PURE__ */ jsx(X, {}),
                /* @__PURE__ */ jsx("span", { className: "garden:sr-only", children: "Close" })
              ]
            }
          )
        ]
...
const GardenFlow = ({
  ...
  const toggleRelation = useCallback((relation) => {
  ...
  const onLayout = useCallback(
    async (nodes2, edges2) => {
      ...
      const result = await plugin?.position?.(nodes2, edges2) ?? {
        nodes: nodes2,
        edges: edges2
      };
  ...
  const handleNodeClick = useCallback(
    (_, node) => {
      if (node.type === "sprout") {
        ...
        const garden = findGardenByName(schema, node.data?.label);
        if (garden) {
  ...
  const handleToggleExpandedSubgardens = (expand) => {
    setIsSubgardensExpanded(expand);
    const garden = findGardenByName(
      schema,
      currentGarden?.data?.label
    );
    if (!garden) return;
    const { nodes: updatedNodes, edges: updatedEdges } = gardenToFlow({
      schema,
      ...
      children: [
        /* @__PURE__ */ jsxs(
          index,
          {
            ...
            children: [
              ...
              currentGarden && /* @__PURE__ */ jsx(Panel, { position: "top-right", children: /* @__PURE__ */ jsxs(
                "div",
                {
                  ...
                  style: {
                    color: currentGarden.data?.theme?.primary_color ?? void 0,
                    borderColor: currentGarden.data?.theme?.secondary_color ?? void 0
                  },
                  children: [
                    /* @__PURE__ */ jsx(Flower, { className: "garden:h-4 garden:w-4" }),
                    currentGarden.data?.label ?? "Garden",
                    currentGarden.data?.icon && /* @__PURE__ */ jsx("span", { className: "garden:ml-1", children: currentGarden.data.icon })
                  ]
                }
              ) }),
              showPoweredBy && /* @__PURE__ */ jsx(Panel, { position: "bottom-right", children: /* @__PURE__ */ jsxs(
                "a",
                {
                  ...
                  style: {
                    color: currentGarden?.data?.theme?.primary_color ?? "var(--garden-primary)",
                    borderColor: currentGarden?.data?.theme?.secondary_color ?? "var(--garden-border)"
                  },
                  children: [
              ...
              showControls && /* @__PURE__ */ jsx(
                Controls,
                {
                  ...
                  children: /* @__PURE__ */ jsx(
                    ControlButton,
                    {
                      title: isSubgardensExpanded ? "Collapse Subgardens" : "Expand Subgardens",
                      "aria-label": isSubgardensExpanded ? "Collapse Subgardens" : "Expand Subgardens",
                      onClick: () => isSubgardensExpanded ? handleToggleExpandedSubgardens(false) : handleToggleExpandedSubgardens(true),
                      children: isSubgardensExpanded ? /* @__PURE__ */ jsx(Layers, {}) : /* @__PURE__ */ jsx(Layers2, {})
                    }
                  )
                }
              )
        ...
        /* @__PURE__ */ jsx(
          Dialog,
          {
            ...
            children: /* @__PURE__ */ jsxs(DialogContent, { className: "garden:sm:max-w-[500px]", children: [
              ...
              /* @__PURE__ */ jsxs(DialogFooter, { className: "garden:flex garden:flex-col garden:gap-2 garden:sm:flex-row garden:sm:justify-between garden:sm:gap-0", children: [
                /* @__PURE__ */ jsxs("div", { className: "garden:flex garden:gap-2", children: [
                  selectedSprout?.cta?.primary && /* @__PURE__ */ jsx(
                    Button,
                    {
                      variant: "default",
                      onClick: () => window.open(selectedSprout.cta?.primary.url, "_blank"),
                      children: selectedSprout.cta.primary.label || "View"
                    }
                  ),
                  selectedSprout?.cta?.secondary && /* @__PURE__ */ jsx(
                    Button,
                    {
                      variant: "outline",
                      onClick: () => window.open(selectedSprout.cta?.secondary?.url, "_blank"),
                      children: selectedSprout.cta.secondary.label || "Source"
                    }
                  )
                ] }),
                /* @__PURE__ */ jsx(DialogClose, { asChild: true, children: /* @__PURE__ */ jsx(Button, { variant: "secondary", children: "Close" }) })
              ] })
            ] })
          }
        )
...
const Garden = ({
  ...
  const initialGarden = initialGardenName ? findGardenByName(convertedSchema, initialGardenName) : convertedSchema;
