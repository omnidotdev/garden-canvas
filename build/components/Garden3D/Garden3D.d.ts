 ...
 * bundle.
 */
declare const Garden3D: ({ schema, nodes, edges, relationColors, showEdges: controlledShowEdges, onShowEdgesChange, showPoweredBy, }: GardenRendererProps) => import("react/jsx-runtime").JSX.Element;
